...
function App() {
  ...
  return (
    <div className="flex flex-row w-full h-full overflow-hidden">
      ...
      >
        <div className="absolute left-0 top-0 w-[100vw] p-4 bg-[var(--background-gray-main)] flex items-center gap-2">
                ...
                >
                  <div className="simplebar-content" style={{ padding: '0px' }}>
                    <div className="flex flex-col h-full flex-1 min-w-0 mx-auto w-full sm:min-w-[390px] px-5 justify-center items-start gap-2 relative max-w-full sm:max-w-full">
                      ...
                      <div className="w-[80%] max-w-full sm:max-w-[768px] sm:min-w-[390px] mx-auto mt-[180px]">
                                ...
                                <footer className="flex flex-row justify-between w-full px-3">
                                  ...
                                  <div className="flex gap-2">
                                    <button
                                      ...
                                      className="whitespace-nowrap text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-primary-foreground hover:bg-primary/90 p-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors bg-[var(--fill-tsp-white-dark)]"
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="15"
                            ...
                            >
                              <div className="flex flex-col items-start gap-[15px] self-stretch max-h-full">
                                <div className="w-8 h-8 bg-black rounded-full group-hover:opacity-0 duration-300 absolute top-[24px] justify-center items-center left-[20px] dark:bg-[var(--icon-primary)]">
                                  <img
                                    className="w-1/2 h-1/2 left-1/2 top-1/2 absolute -translate-x-1/2 -translate-y-1/2 brightness-100 dark:brightness-0"
                                    alt=""
