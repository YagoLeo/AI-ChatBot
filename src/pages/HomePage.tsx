...
function App() {
  ...
  // First, create a cards data array
  const cards = [
    {
      id: 1,
      icon: 'https://files.manuscdn.com/assets/icon/session/online-learning-book-open.svg',
      title: '四月日本之旅',
      description:
        'Manus集成全面的旅游信息，制定个性化的行程，并制作专为您的日本旅行量身定制的旅行手册。',
      image:
        'https://files.manuscdn.com/webapp/_next/static/media/img24.fad57c99.webp',
    },
    {
      id: 2,
      icon: 'https://files.manuscdn.com/assets/icon/session/data-analysis.svg',
      title: '数据分析报告',
      description:
        '利用AI强大的数据处理能力，快速生成专业的数据分析报告，助您洞察市场趋势。',
      image:
        'https://files.manuscdn.com/webapp/_next/static/media/img49.2b5ddcd6.webp',
    },
    {
      id: 3,
      icon: 'https://files.manuscdn.com/assets/icon/session/writing.svg',
      title: '文章创作',
      description:
        '智能辅助写作，帮助您快速生成高质量的文章内容，提升创作效率。',
      image:
        'https://files.manuscdn.com/webapp/_next/static/media/img38.6cb28611.webp',
    },
    {
      id: 4,
      icon: 'https://files.manuscdn.com/assets/icon/session/coding.svg',
      title: '代码助手',
      description: '智能代码补全和优化建议，让编程更轻松高效。',
      image:
        'https://files.manuscdn.com/webapp/_next/static/media/img50.4a6ca47f.webp',
    },
  ];
  ...
  return (
    <div className="flex w-full h-full overflow-hidden">
      {/* Add trigger area */}
      <div
        className="fixed top-0 left-0 h-full w-[300px] z-[1]"
        onMouseEnter={() => setShowSidebar(true)}
        onMouseLeave={() => setShowSidebar(false)}
      >
        {/* Sidebar */}
        <div
          className="flex flex-col overflow-hidden bg-[var(--background-nav)] fixed top-1 start-1 bottom-1 z-[1] border-1 dark:border-[1px] border-[var(--border-main)] dark:border-[var(--border-light)] rounded-xl shadow-[0px_8px_32px_0px_rgba(0,0,0,0.16),0px_0px_0px_1px_rgba(0,0,0,0.06)]"
          style={{
            width: '300px',
        ...
        >
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-4">
            <div className="flex flex-col items-center gap-2 text-[var(--text-tertiary)]">
              ...
              >
                <path d="M10 17H7l-4 4v-7"></path>
                <path d="M14 17h1"></path>
                <path d="M14 3h1"></path>
                <path d="M19 3a2 2 0 0 1 2 2"></path>
                <path d="M21 14v1a2 2 0 0 1-2 2"></path>
                <path d="M21 9v1"></path>
                <path d="M3 9v1"></path>
                <path d="M5 3a2 2 0 0 0-2 2"></path>
                <path d="M9 3h1"></path>
              </svg>
              <span className="text-sm font-medium">新建一个任务以开始</span>
            </div>
          </div>
        ...
        <div className="flex h-full bg-[var(--background-gray-main)]">
          <div className="flex flex-1 min-w-0 min-h-0">
            <div className="[&_.simplebar-scrollbar]:opacity-0 [&_.simplebar-scrollbar::before]:w-[var(--simplebar-scrollbar-width)] [&_.simplebar-scrollbar::before]:bg-[var(--text-disable)] [&_.simplebar-track.simplebar-vertical]:w-[calc(var(--simplebar-scrollbar-width)+2px)] [&_.simplebar-track.simplebar-vertical]:mr-1 [&:hover_.simplebar-scrollbar]:opacity-100 [&:hover_.simplebar-scrollbar::before]:bg-[var(--text-tertiary)] [&_.simplebar-track.simplebar-vertical.simplebar-hover_.simplebar-scrollbar::before]:bg-[var(--text-tertiary)] [&_.simplebar-content-wrapper]:flex [&_.simplebar-content-wrapper]:flex-col [&_.simplebar-content-wrapper]:h-full [&_.simplebar-content]:flex [&_.simplebar-content]:flex-1 flex flex-1 min-w-0 h-full [&_.simplebar-content]:flex-row simplebar-scrollable-y">
              <div className="simplebar-wrapper" style={{ margin: 0 }}></div>
            </div>
                ...
                >
                  <div className="simplebar-content" style={{ padding: '0px' }}>
                    <div className="flex flex-col h-full flex-1 min-w-0 mx-auto w-full sm:min-w-[390px] px-5 justify-center items-start gap-2 relative max-w-full sm:max-w-full">
                      <div className="relative flex" style={{ top: '20px' }}>
                      ...
                      <div className="w-1/2 max-w-full sm:max-w-[768px] sm:min-w-[390px] mx-auto mt-[180px]">
                              ...
                              <div className="flex flex-col gap-3 rounded-[22px] transition-all relative bg-[var(--fill-input-chat)] py-3 max-h-[300px] shadow-[0px_12px_32px_0px_rgba(0,0,0,0.02)] border border-black/8 dark:border-[var(--border-main)]">
                                ...
                                <footer className="flex flex-row justify-between w-full px-3">
                                  <div className="flex gap-2 pr-2 items-center">
                                    <button
                                      className="rounded-full border border-[var(--border-main)] inline-flex items-center justify-center gap-1 clickable cursor-pointer text-xs text-[var(--text-secondary)] hover:bg-[var(--fill-tsp-gray-main)] w-8 h-8 p-0"
                                      data-state="closed"
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  <div className="flex gap-2">
                                    <button
                                      ...
                                      className="whitespace-nowrap text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring text-primary-foreground hover:bg-primary/90 p-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors bg-[var(--Button-primary-black)]"
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="15"
                      ...
                      <div className="flex flex-col items-center px-0 rounded-[64px] w-full max-w-[1608px] max-md:bg-transparent max-md:py-[64px] max-md:gap-[30px] pt-40 max-md:pt-[80px] max-md:pb-[0px] pb-5 gap-[64px]">
                        <div className="flex flex-col justify-center items-center gap-8 max-md:gap-[16px] self-stretch flex-wrap">
                          <div className="flex flex-wrap justify-center items-center gap-3 self-stretch max-md:px-[6px] max-md:justify-center overflow-x-auto px-4 py-0 opacity-0 animate-text-fade-in delay-100">
                            {[
                              { label: '精选', active: true },
                              { label: '研究', active: false },
                              { label: '生活', active: false },
                              { label: '数据分析', active: false },
                              { label: '教育', active: false },
                              { label: '生产力', active: false },
                              { label: '这也行', active: false },
                            ].map((item) => (
                              <div
                                key={item.label}
                                className={`flex justify-center items-center gap-1.5 self-stretch select-none cursor-pointer
            max-md:text-[13px] max-md:px-[12px] max-md:py-[8px] duration-150 text-base font-medium
            leading-5 tracking-[-0.024px] px-6 py-2 rounded-[100px] border-[rgba(0,0,0,0.12)]
            border border-solid ${
              item.active
                ? 'text-white bg-[#1A1A19]'
                : 'text-[#858481] hover:bg-[rgba(55,53,47,0.06)]'
            }`}
                              >
                                {item.label}
                              </div>
                        ...
                        <div className="flex w-full flex-row justify-start flex-wrap items-start gap-6 px-[74px] max-2xl:px-[10px] max-xl:px-[10px] max-lg:px-[20px] max-md:px-[20px] max-sm:px-[20px]">
                          {cards.map((card) => (
                            <div
                              key={card.id}
                              className="group cursor-pointer w-[calc(25%-18px)] max-xl:w-[calc(33.333%-16px)] max-lg:w-[calc(50%-12px)] max-sm:w-full gap-3 relative overflow-hidden self-stretch p-6 pt-[70px] border aspect-[384/420] max-md:aspect-[384/380] bg-[#FAFAFA] rounded-[18px] flex flex-col items-start border-solid border-[rgba(0,0,0,0.10)] opacity-0 animate-text-fade-in"
                              style={{ animationDelay: `${120 * card.id}ms` }}
                            >
                              <div className="flex flex-col items-start gap-[15px] self-stretch max-h-full">
                                <div className="w-8 h-8 bg-black rounded-full group-hover:opacity-0 duration-300 absolute top-[24px] justify-center items-center left-[20px] dark:bg-[var(--icon-primary)]">
                                  <img
                                    className="w-2/3 h-1/2 left-1/2 top-1/2 absolute -translate-x-1/2 -translate-y-1/2 brightness-100 dark:brightness-0"
                                    alt=""
                                    src="https://files.manuscdn.com/assets/icon/session/online-learning-book-open.svg"
                                    data-px-source="true"
                                  />
                                </div>

                                <img
                                  src="https://files.manuscdn.com/webapp/_next/static/media/playIcon.8f86dad6.png"
                                  className="absolute left-[22px] top-[22px] w-9 h-9 shrink-0 rounded-full opacity-0 group-hover:opacity-100 shadow-[0px_4px_12px_0px_rgba(0,0,0,0.25)] duration-300"
                                  alt="play icon"
                                />

                                <div className="w-full z-[1] duration-300 bg-gradient-to-t from-[#FAFAFA] to-transparent absolute left-0 bottom-0 group-hover:h-12 h-[40%]" />
                                ...
                                >
                                  ...
                                  >
                                    <div className="font-serif text-[#262626] mb-[15px] max-xl:mb-[10px] max-2xl:text-[16px] text-[18px] font-normal leading-[120%] !text-[14px] !mb-[10px] dark:text-[#DBDBDB]">
                                      {card.title}
                                    </div>
                                    <div className="text-[color:var(--text-tertiary)] text-[16px] pb-4 !text-[13px] leading-[16px]">
                                      {card.description}
                                    </div>
                                  </div>
                                </div>
                              ...
                              <img
                                src={card.image}
                                className="absolute z-[1] w-[70%] left-[15%] bottom-[-25%] aspect-[275/210] rounded-md border border-solid border-[rgba(0,0,0,0.10)] shadow-[0px_4px_27px_0px_rgba(0,0,0,0.20)] object-cover transition-all duration-400 group-hover:bottom-[-40%]"
                        ...
                        <div
                          className="group rounded-full relative inline-flex h-11 animate-rainbow cursor-pointer items-center justify-center border-0 bg-[length:200%] px-8 max-md:px-[12px] py-2 font-medium text-primary-foreground transition-colors [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))] before:[filter:blur(calc(0.8*1rem))] bg-[linear-gradient(#121213,#121213),linear-gradient(#121213_50%,rgba(18,18,19,0.6)_80%,rgba(18,18,19,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))] opacity-0 animate-text-fade-in"
                          style={{ animationDelay: '1440ms' }}
                        >
                          <button
                            className="relative flex w-fit cursor-pointer items-center justify-center rounded-lg border-none bg-primary text-primary-foreground px-0"
                            style={{ opacity: 1 }}
                          >
                            <span
                            ...
                            >
                              <span className="group inline-flex items-center text-white font-medium group-hover:opacity-80 duration-300">
                                探索更多使用案例
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="24"
